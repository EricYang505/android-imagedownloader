...
public class EYImageDownloader {
    ...
    public void download(String url, ImageListActivity.ViewHolder viewHolder) {
        ...
        if (viewHolder.taskWeakReference!=null){
            BitmapDownloaderTask task = (BitmapDownloaderTask) viewHolder.taskWeakReference.get();
...
//            }
    ...
    public class BitmapDownloaderTask extends AsyncTask<String, Void, Bitmap> {
        private final WeakReference<ImageListActivity.ViewHolder> viewHolderWeakReference;
        public String url;

        public BitmapDownloaderTask(ImageListActivity.ViewHolder viewHolder) {
            viewHolderWeakReference = new WeakReference<ImageListActivity.ViewHolder>(viewHolder);
        }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            if (viewHolderWeakReference != null) {
                ImageListActivity.ViewHolder viewHolder = viewHolderWeakReference.get();
